package com.mirea.pershinadv.camera;
...
import com.mirea.pershinadv.camera.databinding.ActivityMainBinding;
...
public	class	MainActivity	extends	AppCompatActivity implements ActivityResultCallback<ActivityResult>{
    ...
    public void OnUpdatePhoto(View v) {
        ...
        try {
            ...
            String authorities = "com.mirea.pershinadv.camera.fileprovider";
